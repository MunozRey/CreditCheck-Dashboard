...
export default function CustomTooltip({ active, payload, label, formatter }) {
  ...
  return (
    <div style={{ background: T.surface, borderRadius: 10, padding: '12px 16px', border: `1px solid ${T.borderHi}`, boxShadow: '0 4px 24px rgba(0,0,0,0.15)', minWidth: 180, fontFamily: "'Geist',sans-serif" }}>
